...
import { challengeOptions, challenges, maxHearts } from "@/db/schema";
      ...
      <>
        ...
        <div className="flex flex-col gap-y-4 lg:gap-y-4 max-w-lg mx-auto text-center items-center justify-center h-full">
          ...
          <h1 className="text-xl lg:text-3xl font-bold text-neutral-700">
            Awesome work! <br /> You&apos;ve completed the lesson.
          </h1>
      ...
      <div className="flex-1">
        <div className="h-full flex items-center justify-center">
          <div className="lg:min-h-[350px] lg:w-[600px] w-full px-6 lg:px-0 flex flex-col gap-y-12">
            <h1 className="text-lg lg:text-3xl text-center lg:text-start font-bold to-neutral-700">
              {title}
            </h1>
            <div>
              {challenge.type === "ASSIST" && (
